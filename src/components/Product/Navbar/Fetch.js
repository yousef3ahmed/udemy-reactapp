                        ...
                        if( this.props.id == item.id ){
                            return(
                                    <>
                                        ...
                                        <h5 className='Down' > { item.description } </h5>
                                        
                                        <div className='CreateDi' >
                                            <Star cnt = { 4 } ></Star>
                                            <a href='#' > <p>  ({ item.totalreviews } ratings) </p> </a>
                                            <p className='CW' >{ item.enrollments } students</p>
                                        </div>

                                        <div className='CreateDi' >
                                          <p className='WNav' >Created by</p>
                                          <a href='#' > <p className='C' >  { item.Title } </p> </a>
                                        </div>

                                        <div className='CreateDiD' >
                                        
                                        <svg xmlns="http://www.w3.org/2000/svg" color='#f0f0f0' width="13" height="13" fill="currentColor" class="bi bi-clipboard2-minus-fill" viewBox="0 0 16 16">
                                        ...
                                        <p  className='CWW' > Last updated { item.lastupdated } </p>

                                        <svg xmlns="http://www.w3.org/2000/svg" color='#f0f0f0' width="13" height="13" fill="currentColor" class="bi bi-globe2" viewBox="0 0 16 16">
                                        ...
                                        <p  className='CWW' > English </p>

                                        <svg xmlns="http://www.w3.org/2000/svg" color='#f0f0f0' width="13" height="13" fill="currentColor" class="bi bi-badge-cc" viewBox="0 0 16 16">
